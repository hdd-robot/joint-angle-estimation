...
using OpenPose installed locally (pyopenpose).
"""
...
def create_openpose_detector(
    ...
    """
    Factory function to create an OpenPose detector.
    ...
    logger.info(f"OpenPose: {openpose_path}")
...
def process_bag_file(
    ...
    # Initialize OpenPose
    detector = create_openpose_detector(openpose_path=openpose_path)
